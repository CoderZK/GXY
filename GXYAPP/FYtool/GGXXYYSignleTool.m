...
#import "GGXXYYSignleTool.h"
static GGXXYYSignleTool * tool = nil;


@implementation GGXXYYSignleTool

+ (GGXXYYSignleTool *)shareTool {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        tool = [[GGXXYYSignleTool alloc] init];
    });
    return tool;
}
...
//        NSDictionary * dic = @{
//                               @"token":deviceToken,
//                               @"userId":[GGXXYYSignleTool shareTool].userInfoModel.ID,
//                               @"type":@"1"
//                               };
//        [GGXXYYRequestTool networkingPOST:[GGXXYYURL getsaveUPushTokenURL] parameters:dic success:^(NSURLSessionDataTask *task, id responseObject) {
//            
//            NSLog(@"上传友盟推送成功\n%@",responseObject);
//            
