...
#import "GGXXYYXieYiVC.h"
@interface GGXXYYLoginVC()
...
- (IBAction)xieYiAction:(id)sender {
    ...
    GGXXYYXieYiVC * vc =[[GGXXYYXieYiVC alloc] init];
        ...
        while ([result next]) {
            ...
            if ([name isEqualToString:self.nameTF.text]) {
                ...
                if ([passWord isEqualToString:self.passWordTF.text]) {
                    ...
                    [GGXXYYSignleTool shareTool].isLogin = YES;
                    [GGXXYYSignleTool shareTool].session_uid = self.nameTF.text;
