...
//    }
    ...
    [self setNavRightBtnWithImg:@"search" title:nil withBlock:^(UIButton *rightBtn) {
        ...
        kkSearchTVC * vc =[[kkSearchTVC alloc] initWithTableViewStyle:UITableViewStyleGrouped];
...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController {
   ...
   BaseNavigationController * vc = ((BaseNavigationController *)viewController);
    ...
    if (([[vc.childViewControllers lastObject] isKindOfClass:[NewsVC class]] || [[vc.childViewControllers lastObject] isKindOfClass:[YJGouWuChe class]])&& ![zkSignleTool shareTool].isLogin) {
